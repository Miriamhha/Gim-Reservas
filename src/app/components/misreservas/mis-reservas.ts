...
//     if (!this.user) { alert('Inicia sesión antes de reservar'); return; }
//     try {
...
//         creada: new Date()
//       });
//       await this.reservasService.actualizarCupo(reserva.id, reserva.inscritos, reserva.capacidadMax);
